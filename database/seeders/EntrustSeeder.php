...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin=User::create(['first_name'=>'Admin','last_name'=>'System','username'=>'admin','email'=>'admin@omega.com','mobile'=>'05999565','email_verified_at'=>now(),'password'=>bcrypt('123123123'),'status'=>1,'remember_token'=>Str::random(10),]);
        $admin->attachRole($adminRole);

        $supervisor=User::create(['first_name'=>'supervisor','last_name'=>'System','username'=>'supervisor','email'=>'supervisor@omega.com','mobile'=>'059995651','email_verified_at'=>now(),'password'=>bcrypt('123123123'),'status'=>1,'remember_token'=>Str::random(10),]);
        $supervisor->attachRole($SupervisorRole);


        $customer=User::create(['first_name'=>'mohammed','last_name'=>'siam','username'=>'moh','email'=>'moh@omega.com','mobile'=>'059995652','email_verified_at'=>now(),'password'=>bcrypt('123123123'),'status'=>1,'remember_token'=>Str::random(10),]);
        $customer->attachRole($CustomerRole);

        
        for($i=1 ;$i <= 20; $i++){
            $Random_customer=User::create(['first_name'=>$faker->firstName,'last_name'=>$faker->lastName,'username'=>$faker->unique()->userName,'email'=>$faker-> unique()->safeEmail,
            'mobile'=>'059'.$faker->numberBetween(100000,999999),'email_verified_at'=>now(),'password'=>bcrypt('123123123'),'status'=>1,
