    ...
    <form wire:submit.prevent="{{ $editMode ? 'update_address' : 'store_address' }}" x-show="formShow" @click.away="formShow = false">
        ...
        <div class="row">
            <div class="col-lg-8 form-group">
                ...
                <input class="form-control" style="background : #f3f3f3;" wire:model="address_title" type="text" placeholder="Enter your address title">
                @error('address_title')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
            <div class="col-lg-4 form-group">
                <label class="text-small text-uppercase">&nbsp;</label>
                <div class="form-check">
                    <input class="form-check-input"style="background : #f3f3f3;" id="rememberme" wire:model="default_address" type="checkbox">
                    <label class="checkbox" for="rememberme">Default address?</label>
                </div>
            </div>
            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="first_name">First name</label>
                <input class="form-control form-control-lg"style="background : #f3f3f3;" wire:model="first_name" type="text" placeholder="Enter your first name">
                @error('first_name')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="last_name">Last name</label>
                <input class="form-control form-control-lg"style="background : #f3f3f3;" wire:model="last_name" type="text" placeholder="Enter your last name">
                @error('last_name')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="email">Email address</label>
                <input class="form-control form-control-lg"style="background : #f3f3f3;" wire:model="email" type="email" placeholder="e.g. Jason@example.com">
                @error('email')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="mobile">Mobile number</label>
                <input class="form-control form-control-lg"style="background : #f3f3f3;" wire:model="mobile" type="tel" placeholder="e.g. 966512345678">
                @error('mobile')<span class="text-danger">{{ $message }}</span>@enderror
            </div>

            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="address">address</label>
                <input class="form-control form-control-lg" style="background : #f3f3f3;"wire:model="address" type="text" placeholder="Enter your first name">
                @error('address')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="address2">address2</label>
                <input class="form-control form-control-lg"style="background : #f3f3f3;" wire:model="address2" type="text" placeholder="Enter your last name">
            ...
            <div class="col-lg-4 form-group">
                ...
                <select class="form-control form-control-lg"style="background : #f3f3f3;" wire:model="country_id">
            ...
            <div class="col-lg-4 form-group">
                ...
                <select class="form-control form-control-lg"style="background : #f3f3f3;" wire:model="state_id">
            ...
            <div class="col-lg-4 form-group">
                ...
                <select class="form-control form-control-lg"style="background : #f3f3f3;" wire:model="city_id">
            ...
            <div class="col-lg-6 form-group">
                ...
                <input class="form-control form-control-lg"style="background : #f3f3f3;" wire:model="zip_code" type="text" placeholder="Enter your first name">
                @error('zip_code')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="po_box">P.O.Box</label>
                <input class="form-control form-control-lg"style="background : #f3f3f3;" wire:model="po_box" type="text" placeholder="Enter your last name">
