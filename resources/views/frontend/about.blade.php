	...
	<section class="section" id="page-about">
		<div class="container">
			<div class="row align-items-center mb-5">
				...
				<div class="col-lg-8">
					<div class="image">
						<img src="{{asset('frontend/dist/images/about-1.jpg') }}" class="img-fluid" alt="">
						<div class="caption">
							<span>Our</span>
							<span>Office</span>
						</div>
			...
			<div class="row align-items-center mb-5">
				<div class="col-lg-8">
					<div class="image">
						<img src="{{asset('frontend/dist/images/about-2.jpg') }}" class="img-fluid" alt="">
						<div class="caption">
							<span>Mission</span>
						</div>
					</div>
				...
				<div class="col-12" id="our-team">
					<div class="row">
						<div class="col-lg-3 col-md-6 mb-4">
							<div class="author">
								<img src="{{asset('frontend/dist/images/users/8.jpg') }}"  alt="">
								<h3>Hussam</h3>
								<p>Web Developer</p>
								<ul class="social">
						...
						<div class="col-lg-3 col-md-6 mb-4">
							<div class="author">
								<img src="{{asset('frontend/dist/images/users/7.jpg') }}" alt="">
								<h3>Toyler</h3>
						...
						<div class="col-lg-3 col-md-6 mb-4">
							<div class="author">
								<img src="{{asset('frontend/dist/images/users/5.jpg') }}" alt="">
								<h3>Kevin</h3>
						...
						<div class="col-lg-3 col-md-6 mb-4">
							<div class="author">
								<img src="{{asset('frontend/dist/images/users/6.jpg') }}" alt="">
								<h3>Alex</h3>
								<p>Web Designer</p>
								<ul class="social">
									<li><a href="#!" target="_blank"><i class="bx bxl-facebook"></i></a></li>
